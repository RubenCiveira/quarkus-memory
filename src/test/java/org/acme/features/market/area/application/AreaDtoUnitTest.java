...
class AreaDtoUnitTest {
  ...
  void test_area_dto_builder() {
    ...
    Area fixRef = Area.builder().uid(AreaUidVO.from("two")).name(AreaNameVO.from("two"))
        .place(AreaPlaceVO.from(PlaceReference.of("two"))).version(AreaVersionVO.from(2)).build();
    Area other;
    ...
    Assertions.assertEquals(PlaceReference.of("one"), dto.getPlace().getValue());
    ...
    Assertions.assertEquals(PlaceReference.of("one"), other.getPlace().getValue());
    ...
    Assertions.assertEquals(PlaceReference.of("two"), other.getPlace().getValue());
