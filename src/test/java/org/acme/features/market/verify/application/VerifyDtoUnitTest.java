...
class VerifyDtoUnitTest {
  ...
  void test_verify_dto_builder() {
    ...
    Verify fixRef = Verify.builder().uid(VerifyUidVO.from("two")).name(VerifyNameVO.from("two"))
        .medals(VerifyMedalsVO.from(List.of(VerifyMedal.builder().uidValue("two")
    ...
    Assertions.assertEquals(List.of(VerifyMedal.builder().uidValue("one")
        .medalValue(MedalReference.of("one")).versionValue(1).build()), dto.getMedals().getValue());
    ...
    Assertions.assertEquals(List.of(VerifyMedal.builder().uidValue("two")
        .medalValue(MedalReference.of("two")).versionValue(2).build()),
        other.getMedals().getValue());
