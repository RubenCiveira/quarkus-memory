...
class VerifyUnitTest {
  ...
  void test_verify_builder() {
    ...
    Assertions.assertEquals(null, entity.getMedals().getValue());
    Assertions.assertEquals(null, entity.getMedalsValue());
    ...
    Assertions.assertEquals(null, entity.withMedalsValue(null).getMedalsValue());
    ...
    Assertions.assertEquals(entity, Verify.builder().uidValue("one").nameValue("one")
        .medalsValue(null).versionValue(1).build());
  }
}
