...
import org.acme.features.market.color.application.service.event.ColorHiddenFieldsPipelineEvent;
import org.acme.features.market.color.application.service.event.ColorVisibilityQueryPipelineEvent;
import org.acme.features.market.color.application.service.event.ColorVisibleContentPipelineEvent;
...
public class ColorsVisibilityService {
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<ColorFixedFieldsPipelineEvent> fireFix;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<ColorHiddenFieldsPipelineEvent> fireHide;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<ColorVisibilityQueryPipelineEvent> fireVisibleFilter;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<ColorVisibleContentPipelineEvent> fireVisibleList;
   ...
   * @return The input entity with the copy values without hidden
   */
  public ColorDto copyWithFixed(Interaction prev, Color original, ColorDto source) {
  ...
  public Set<String> fieldsToFix(Interaction prev) {
    ...
    ColorFixedFieldsPipelineEvent value =
        ColorFixedFieldsPipelineEvent.builder().fields(fields).query(prev).build();
    fireFix.fire(value);
  ...
  public Set<String> fieldsToFix(Interaction prev, ColorRef color) {
    ...
    fields.addAll(aggregate.calcultadFields());
    ColorFixedFieldsPipelineEvent value =
        ColorFixedFieldsPipelineEvent.builder().fields(fields).color(color).query(prev).build();
    fireFix.fire(value);
    return value.getFields();
  }
  ...
  public Set<String> fieldsToHide(Interaction prev) {
    ...
    ColorHiddenFieldsPipelineEvent value =
        ColorHiddenFieldsPipelineEvent.builder().fields(fields).query(prev).build();
    fireHide.fire(value);
    return value.getFields();
  }
  ...
  public Set<String> fieldsToHide(Interaction prev, ColorRef color) {
    Set<String> fields = new HashSet<>();
    ColorHiddenFieldsPipelineEvent value =
        ColorHiddenFieldsPipelineEvent.builder().fields(fields).color(color).query(prev).build();
    fireHide.fire(value);
    return value.getFields();
  }
  ...
  private ColorFilter applyPreVisibilityFilter(Interaction prev, ColorFilter filter) {
    ColorVisibilityQueryPipelineEvent visible =
        ColorVisibilityQueryPipelineEvent.builder().filter(filter).interaction(prev).build();
  ...
  private boolean evaluatePostVisibility(Interaction prev, Color colorRef) {
    ColorVisibleContentPipelineEvent accesible = ColorVisibleContentPipelineEvent.builder()
        .visible(true).entity(colorRef).interaction(prev).build();
