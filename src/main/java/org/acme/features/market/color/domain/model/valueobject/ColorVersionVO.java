...
public class ColorVersionVO {
   ...
   */
  public static ColorVersionVO empty() {
    return new ColorVersionVO(null);
  }
   ...
   * @return An empty instance
   */
  public static ColorVersionVO from(final Integer version) {
   ...
   * @return An empty instance
   */
  public static ColorVersionVO tryFrom(final Object version) {
    ConstraintFailList list = new ConstraintFailList();
    ColorVersionVO result = tryFrom(version, list);
    if (list.hasErrors()) {
   ...
   * @return An empty instance
   */
  public static ColorVersionVO tryFrom(final Object version, final ConstraintFailList fails) {
    if (null == version) {
      return new ColorVersionVO(null);
    } else if (version instanceof Integer) {
      return new ColorVersionVO((Integer) version);
    } else {
