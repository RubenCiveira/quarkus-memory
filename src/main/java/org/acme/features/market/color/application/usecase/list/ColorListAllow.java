...
public class ColorListAllow extends AllowResult {
   ...
   * @return
   */
  public static ColorListAllow build(final Interaction query, final boolean allowed) {
  ...
  public static ColorListAllow build(final Interaction query, final boolean allowed,
      final String reason) {
    return ColorListAllow.builder().query(query).detail(CompletableFuture
