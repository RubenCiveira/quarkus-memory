...
public class ColorCreateAllow extends AllowResult {
   ...
   * @return
   */
  public static ColorCreateAllow build(final Interaction query, final boolean allowed) {
  ...
  public static ColorCreateAllow build(final Interaction query, final boolean allowed,
      final String reason) {
    return ColorCreateAllow.builder().query(query).detail(CompletableFuture
