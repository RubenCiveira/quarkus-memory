...
public class ColorCreateAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static ColorCreateAllowProposal build(final Interaction query, final boolean allowed) {
  ...
  public static ColorCreateAllowProposal build(final Interaction query, final boolean allowed,
      final String reason) {
    return ColorCreateAllowProposal.builder().query(query)
   ...
   * @return
   */
  public static Allow resolveWith(final Event<ColorCreateAllowProposal> emitter,
      final ColorCreateAllowProposal allow) {
    emitter.fire(allow);
  ...
  public static Allow resolveWith(final Event<ColorCreateAllowProposal> emitter,
    ...
    return resolveWith(emitter, ColorCreateAllowProposal.build(query, allowed));
  }
