...
public class ColorDto {
   ...
   * @return
   */
  private static Map<String, BiConsumer<ColorDto, Color>> toFixCallbacks() {
   ...
   * @return
   */
  private static Map<String, Consumer<ColorDto>> toHideCallbacks() {
  ...
  public void fixField(final String field, final Color color) {
    Map<String, BiConsumer<ColorDto, Color>> toFix = toFixCallbacks();
  ...
  public void hideField(final String field) {
    Map<String, Consumer<ColorDto>> toHide = toHideCallbacks();
