...
public class ColorRetrieveAllow {
   ...
   * @return
   */
  public static ColorRetrieveAllow build(final Optional<ColorRef> reference,
   ...
   * @return
   */
  public static ColorRetrieveAllow build(final Optional<ColorRef> reference, final boolean allowed,
      final String reason) {
    return ColorRetrieveAllow.builder().reference(reference.orElse(null)).detail(CompletableFuture
