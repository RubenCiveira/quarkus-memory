...
public class CreateColorUsecase {
   ...
   * @autogenerated CreateUsecaseGenerator
   */
  private final Event<ColorCreateAllowProposal> createAllow;
   ...
   * @autogenerated CreateUsecaseGenerator
   */
  private final Event<ColorCreateEvent> eventEmitter;
   ...
   * @autogenerated CreateUsecaseGenerator
   */
  private final Event<ColorCreateProposal> proposalEmitter;
  ...
  public Allow allow(final Interaction query) {
    return ColorCreateAllowProposal.resolveWith(createAllow,
        ColorCreateAllowProposal.build(query, true, "Allowed by default"));
  }
  ...
  public ColorDto create(final ColorCreateCommand query) {
    ...
    ColorDto filled = visibility.copyWithFixed(query, query.getDto());
    ColorDto dto = ColorCreateProposal.resolveWith(proposalEmitter, query, filled);
    ...
    ColorCreateEvent.notifyWith(eventEmitter, query, created);
