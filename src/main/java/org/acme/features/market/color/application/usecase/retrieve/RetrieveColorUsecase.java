...
public class RetrieveColorUsecase {
   ...
   */
  private final Event<ColorRetrieveAllowPipelineEvent> retrieveAllow;
  ...
  public Allow allow(final Interaction query, final ColorRef reference) {
    ColorRetrieveAllowPipelineEvent base = ColorRetrieveAllowPipelineEvent.build(query,
  ...
  public Allow allow(final Interaction query) {
    ColorRetrieveAllowPipelineEvent base =
        ColorRetrieveAllowPipelineEvent.build(query, Optional.empty(), true, "Allowed by default");
    retrieveAllow.fire(base);
    return base.getDetail();
  }
   ...
   */
  public ColorDto retrieve(final ColorRetrieveQuery query) {
    Allow detail = allow(query, query.getReference());
    if (!detail.isAllowed()) {
      throw new NotAllowedException(detail.getDescription());
    }
    ColorCached retrieveCachedVisible =
