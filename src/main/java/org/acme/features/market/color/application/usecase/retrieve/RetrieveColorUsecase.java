...
public class RetrieveColorUsecase {
   ...
   */
  private final Event<ColorRetrieveAllowProposal> retrieveAllow;
  ...
  public Allow allow(final Interaction query, final ColorRef reference) {
    ColorRetrieveAllowProposal base =
        ColorRetrieveAllowProposal.build(query, Optional.of(reference), true, "Allowed by default");
  ...
  public Allow allow(final Interaction query) {
    ColorRetrieveAllowProposal base =
        ColorRetrieveAllowProposal.build(query, Optional.empty(), true, "Allowed by default");
    retrieveAllow.fire(base);
    return base.getDetail();
  }
