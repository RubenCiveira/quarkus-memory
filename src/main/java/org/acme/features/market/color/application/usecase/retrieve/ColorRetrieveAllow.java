...
public class ColorRetrieveAllow extends AllowResult {
   ...
   * @return
   */
  public static ColorRetrieveAllow build(final Interaction query,
  ...
  public static ColorRetrieveAllow build(final Interaction query,
    ...
    return ColorRetrieveAllow.builder().query(query).reference(reference.orElse(null))
