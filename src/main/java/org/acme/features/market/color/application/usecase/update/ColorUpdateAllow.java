...
public class ColorUpdateAllow extends AllowResult {
   ...
   * @return
   */
  public static ColorUpdateAllow build(final Interaction query, final Optional<ColorRef> reference,
  ...
  public static ColorUpdateAllow build(final Interaction query, final Optional<ColorRef> reference,
    ...
    return ColorUpdateAllow.builder().query(query).reference(reference.orElse(null))
