...
public class ColorListAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static ColorListAllowProposal build(final Interaction query, final boolean allowed) {
  ...
  public static ColorListAllowProposal build(final Interaction query, final boolean allowed,
      final String reason) {
    return ColorListAllowProposal.builder().query(query)
   ...
   * @return
   */
  public static Allow resolveWith(final Event<ColorListAllowProposal> emitter,
      final ColorListAllowProposal allow) {
    emitter.fire(allow);
  ...
  public static Allow resolveWith(final Event<ColorListAllowProposal> emitter,
    ...
    return resolveWith(emitter, ColorListAllowProposal.build(query, allowed));
  }
