...
public class FruitsVisibilityService {
   ...
   */
  public FruitDto copyWithFixed(Interaction prev, Fruit target, FruitDto source) {
  ...
  public FruitFixedFields fieldsToFix(Interaction prev) {
    FruitFixedFields value = FruitFixedFields.builder().fixed(Set.of()).build(prev);
    fireFix.fire(value);
    return value;
  }
  ...
  public FruitHiddenFields fieldsToHide(Interaction prev) {
    FruitHiddenFields value = FruitHiddenFields.builder().hidden(Set.of()).build(prev);
    fireHide.fire(value);
    return value;
  }
   ...
   * @autogenerated VisibilityServiceGenerator
   * @param prev The source interaction
   * @param fruits The source interaction
   * @return The input dto with hidden values
   */
  public List<Fruit> listableFilter(Interaction prev, Collection<? extends Fruit> fruits) {
    FruitListableContent list = new FruitListableContent(visibleFilter(prev, fruits));
   ...
   * @return The input dto with hidden values
   */
  public List<Fruit> visibleFilter(Interaction prev, Collection<? extends Fruit> fruits) {
    FruitVisibleList list = new FruitVisibleList(fruits);
   ...
   * @autogenerated VisibilityServiceGenerator
   * @param prev The source interaction
   * @param fruit The source interaction
   * @return The input dto with hidden values
   */
  public Optional<Fruit> visibleFilter(Interaction prev, Fruit fruit) {
    FruitVisibleList list = new FruitVisibleList(List.of(fruit));
    fireVisibleList.fire(list);
