...
public class FruitRetrieveAllowPipelineEvent extends AllowPipelineEvent {
   ...
   * @return
   */
  public static FruitRetrieveAllowPipelineEvent build(final Interaction query,
  ...
  public static FruitRetrieveAllowPipelineEvent build(final Interaction query,
    ...
    return FruitRetrieveAllowPipelineEvent.builder().query(query).reference(reference.orElse(null))
