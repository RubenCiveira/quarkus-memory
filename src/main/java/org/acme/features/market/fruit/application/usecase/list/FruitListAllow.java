...
public class FruitListAllow extends AllowResult {
   ...
   * @return
   */
  public static FruitListAllow build(final Interaction query, final boolean allowed) {
  ...
  public static FruitListAllow build(final Interaction query, final boolean allowed,
      final String reason) {
    return FruitListAllow.builder().query(query).detail(CompletableFuture
