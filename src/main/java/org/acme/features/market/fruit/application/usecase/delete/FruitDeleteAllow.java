...
public class FruitDeleteAllow extends AllowResult {
   ...
   * @return
   */
  public static FruitDeleteAllow build(final Interaction query, final Optional<FruitRef> reference,
  ...
  public static FruitDeleteAllow build(final Interaction query, final Optional<FruitRef> reference,
    ...
    return FruitDeleteAllow.builder().query(query).reference(reference.orElse(null))
