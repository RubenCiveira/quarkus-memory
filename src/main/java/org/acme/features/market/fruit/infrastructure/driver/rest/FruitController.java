...
public class FruitController implements FruitApi {
  ...
  public Response fruitApiCreate(Fruit fruit) {
    ...
    try {
      Optional<FruitDto> outputFruit = result.getFruit().get(1, TimeUnit.SECONDS);
   ...
   */
  @Override
  public Response fruitApiList(final Integer limit, final String sinceUid) {
   ...
   * @return
   */
  private FruitApiList200ResponseNext next(List<FruitDto> list) {
    if (list.isEmpty()) {
      return null;
    } else {
