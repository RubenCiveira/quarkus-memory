...
import org.acme.features.market.fruit.domain.interaction.result.FruitFixedFieldsResult;
import org.acme.features.market.fruit.domain.interaction.result.FruitHiddenFieldsResult;
...
public class FruitsVisibility {
     ...
     */
    private final Event<FruitFixedFieldsResult> fireFix;
     ...
     * @autogenerated VisibilityTraitGenerator
     */
    private final Event<FruitHiddenFieldsResult> fireHide;
     ...
     */
    public FruitFixedFieldsResult fieldsToFix(Interaction prev) {
        FruitFixedFieldsResult value = FruitFixedFieldsResult.builder().fixed(Set.of()).build(prev);
        fireFix.fire(value);
        return value;
    }
     ...
     */
    public FruitHiddenFieldsResult fieldsToHide(Interaction prev) {
        FruitHiddenFieldsResult value = FruitHiddenFieldsResult.builder().hidden(Set.of()).build(prev);
        fireHide.fire(value);
        return value;
    }
