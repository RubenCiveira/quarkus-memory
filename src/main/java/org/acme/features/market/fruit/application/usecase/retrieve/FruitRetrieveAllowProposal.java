...
public class FruitRetrieveAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static FruitRetrieveAllowProposal build(final Interaction query,
  ...
  public static FruitRetrieveAllowProposal build(final Interaction query,
    ...
    return FruitRetrieveAllowProposal.builder().query(query).reference(reference.orElse(null))
   ...
   * @return
   */
  public static Allow resolveWith(final Event<FruitRetrieveAllowProposal> emitter,
      final FruitRetrieveAllowProposal allow) {
    emitter.fire(allow);
   ...
   */
  public static Allow resolveWith(final Event<FruitRetrieveAllowProposal> emitter,
      final Interaction query, final Optional<FruitRef> reference, final boolean allowed) {
