...
public class FruitUpdateAllow extends AllowResult {
   ...
   * @return
   */
  public static FruitUpdateAllow build(final Interaction query, final Optional<FruitRef> reference,
  ...
  public static FruitUpdateAllow build(final Interaction query, final Optional<FruitRef> reference,
    ...
    return FruitUpdateAllow.builder().query(query).reference(reference.orElse(null))
