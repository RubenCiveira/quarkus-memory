...
public class FruitDto {
   ...
   * @return
   */
  private static Map<String, BiConsumer<FruitDto, Fruit>> toFixCallbacks() {
   ...
   * @return
   */
  private static Map<String, Consumer<FruitDto>> toHideCallbacks() {
  ...
  public void fixField(final String field, final Fruit fruit) {
    Map<String, BiConsumer<FruitDto, Fruit>> toFix = toFixCallbacks();
  ...
  public void hideField(final String field) {
    Map<String, Consumer<FruitDto>> toHide = toHideCallbacks();
