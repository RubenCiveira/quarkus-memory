...
public class FruitDeleteAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static FruitDeleteAllowProposal build(final Interaction query,
  ...
  public static FruitDeleteAllowProposal build(final Interaction query,
    ...
    return FruitDeleteAllowProposal.builder().query(query).reference(reference.orElse(null))
   ...
   * @return
   */
  public static Allow resolveWith(final Event<FruitDeleteAllowProposal> emitter,
      final FruitDeleteAllowProposal allow) {
    emitter.fire(allow);
