...
public class FruitCreateAllow extends AllowResult {
   ...
   * @return
   */
  public static FruitCreateAllow build(final Interaction query, final boolean allowed) {
  ...
  public static FruitCreateAllow build(final Interaction query, final boolean allowed,
      final String reason) {
    return FruitCreateAllow.builder().query(query).detail(CompletableFuture
