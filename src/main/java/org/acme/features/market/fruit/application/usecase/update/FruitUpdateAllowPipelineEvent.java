...
public class FruitUpdateAllowPipelineEvent extends AllowPipelineEvent {
   ...
   * @return
   */
  public static FruitUpdateAllowPipelineEvent build(final Interaction query,
  ...
  public static FruitUpdateAllowPipelineEvent build(final Interaction query,
    ...
    return FruitUpdateAllowPipelineEvent.builder().query(query).reference(reference.orElse(null))
