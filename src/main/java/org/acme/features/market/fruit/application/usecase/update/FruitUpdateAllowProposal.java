...
public class FruitUpdateAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static FruitUpdateAllowProposal build(final Interaction query,
  ...
  public static FruitUpdateAllowProposal build(final Interaction query,
    ...
    return FruitUpdateAllowProposal.builder().query(query).reference(reference.orElse(null))
   ...
   * @return
   */
  public static Allow resolveWith(final Event<FruitUpdateAllowProposal> emitter,
      final FruitUpdateAllowProposal allow) {
    emitter.fire(allow);
