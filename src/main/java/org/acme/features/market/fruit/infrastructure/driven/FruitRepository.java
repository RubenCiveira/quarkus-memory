...
// CompletableFuture
// .completedFuture(sq
// .query(row -> Optional.of(Fruit.builder().uid(FruitUidVO.from(row.getString(1)))
...
// sq.orderAsc("uid");
// return CompletableFuture.completedFuture(sq.query(row -> Optional.of(Fruit.builder()
