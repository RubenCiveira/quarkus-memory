...
public class FruitsVisibilityService {
   ...
   */
  public FruitFixedFieldsPipelineStageEvent fieldsToFix(Interaction prev) {
   ...
   * @return initialsFixFields
   */
  public FruitFixedFieldsPipelineStageEvent fieldsToFix(Interaction prev, FruitRef fruit) {
   ...
   */
  public FruitHiddenFieldsPipelineStageEvent fieldsToHide(Interaction prev) {
   ...
   * @return initialsHideFields
   */
  public FruitHiddenFieldsPipelineStageEvent fieldsToHide(Interaction prev, FruitRef fruit) {
  ...
  private CompletionStage<List<Fruit>> queryItems(Interaction prev, FruitFilter filter,
      FruitCursor cursor) {
    return fruitReadRepositoryGateway.list(filter, cursor).thenCompose(
