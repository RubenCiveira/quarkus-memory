...
public class Fruits {
   ...
   * @autogenerated AggregateGenerator
   */
  private Map<String, BiFunction<CompletableFuture<FruitBuilder>, Optional<Fruit>, CompletableFuture<FruitBuilder>>> calculatedFields =
      Map.of();
   ...
   * @return The entity
   */
  public CompletableFuture<Fruit> clean(final Fruit entity) {
   ...
   * @return The entity
   */
  public CompletableFuture<Fruit> initialize(final FruitBuilder builder) {
   ...
   * @return The entity
   */
  public CompletableFuture<Fruit> modify(final Fruit base, final FruitBuilder builder) {
   ...
   * @return The entity
   */
  private CompletableFuture<Fruit> applyModify(final FruitActionType type,
      final Optional<Fruit> original, final FruitBuilder builder) {
    CompletableFuture<FruitBuilder> ruledBuilder =
        this.builderRules.applyCurrent(type, builder, original);
    for (BiFunction<CompletableFuture<FruitBuilder>, Optional<Fruit>, CompletableFuture<FruitBuilder>> callback : calculatedFields
        .values()) {
