...
public class RetrieveFruitUsecase {
   ...
   */
  private final Event<FruitRetrieveAllowProposal> retrieveAllow;
  ...
  public Allow allow(final Interaction query, final FruitRef reference) {
    FruitRetrieveAllowProposal base =
        FruitRetrieveAllowProposal.build(query, Optional.of(reference), true, "Allowed by default");
  ...
  public Allow allow(final Interaction query) {
    FruitRetrieveAllowProposal base =
        FruitRetrieveAllowProposal.build(query, Optional.empty(), true, "Allowed by default");
    retrieveAllow.fire(base);
    return base.getDetail();
  }
