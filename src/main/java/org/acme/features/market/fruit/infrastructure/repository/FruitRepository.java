...
public class FruitRepository {
   ...
   * @return
   */
  private <T> SqlSchematicQuery<T> filteredQuery(SqlTemplate template, FruitFilter filter) {
    SqlSchematicQuery<T> sq = template.createSqlSchematicQuery("fruit");
    sq.selectFields("fruit.uid", "fruit.name", "fruit.version");
