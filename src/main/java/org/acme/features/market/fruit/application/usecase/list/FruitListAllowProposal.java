...
public class FruitListAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static FruitListAllowProposal build(final Interaction query, final boolean allowed) {
  ...
  public static FruitListAllowProposal build(final Interaction query, final boolean allowed,
      final String reason) {
    return FruitListAllowProposal.builder().query(query)
   ...
   * @return
   */
  public static Allow resolveWith(final Event<FruitListAllowProposal> emitter,
      final FruitListAllowProposal allow) {
    emitter.fire(allow);
  ...
  public static Allow resolveWith(final Event<FruitListAllowProposal> emitter,
    ...
    return resolveWith(emitter, FruitListAllowProposal.build(query, allowed));
  }
