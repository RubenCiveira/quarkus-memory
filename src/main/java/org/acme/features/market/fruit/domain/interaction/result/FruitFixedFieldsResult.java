...
public class FruitFixedFieldsResult extends Interaction {
   ...
   */
  public FruitFixedFieldsResult and(final String field) {
    fixedEditable().add(field);
    return this;
  }
   ...
   * @return The self instance to chain other calls
   */
  public FruitFixedFieldsResult not(final String field) {
