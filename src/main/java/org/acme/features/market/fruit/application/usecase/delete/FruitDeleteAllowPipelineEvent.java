...
public class FruitDeleteAllowPipelineEvent extends AllowPipelineEvent {
   ...
   * @return
   */
  public static FruitDeleteAllowPipelineEvent build(final Interaction query,
  ...
  public static FruitDeleteAllowPipelineEvent build(final Interaction query,
    ...
    return FruitDeleteAllowPipelineEvent.builder().query(query).reference(reference.orElse(null))
