...
public class FruitRetrieveAllow extends AllowResult {
   ...
   * @return
   */
  public static FruitRetrieveAllow build(final Interaction query,
  ...
  public static FruitRetrieveAllow build(final Interaction query,
    ...
    return FruitRetrieveAllow.builder().query(query).reference(reference.orElse(null))
