...
public abstract class MerchantModifyProposal {
  ...
  public static MerchantDto resolveWith(final Event<? extends MerchantModifyProposal> emitter,
      final MerchantModifyProposal proposal) {
    ((Event<MerchantModifyProposal>) emitter).fire(proposal);
