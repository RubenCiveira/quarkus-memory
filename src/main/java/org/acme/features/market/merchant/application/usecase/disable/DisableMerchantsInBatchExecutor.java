...
class DisableMerchantsInBatchExecutor implements
    StepCounter<MerchantDisableAllInBatchCommand, DisableMerchantsInBatchExecutor.MerchantPaginableBatch>,
    StepFinalizer<MerchantDisableAllInBatchCommand, DisableMerchantsInBatchExecutor.MerchantPaginableBatch>,
    StepInitializer<MerchantDisableAllInBatchCommand, DisableMerchantsInBatchExecutor.MerchantPaginableBatch>,
    ItemReader<Merchant, MerchantDisableAllInBatchCommand, DisableMerchantsInBatchExecutor.MerchantPaginableBatch>,
    ItemWriter<Merchant, MerchantDisableAllInBatchCommand, DisableMerchantsInBatchExecutor.MerchantPaginableBatch>,
    ItemProcessor<Merchant, Merchant, MerchantDisableAllInBatchCommand, DisableMerchantsInBatchExecutor.MerchantPaginableBatch>,
    ItemDescriptor<Merchant, MerchantDisableAllInBatchCommand, DisableMerchantsInBatchExecutor.MerchantPaginableBatch> {
   ...
   * @autogenerated EntityGenerator
   */
  private final DisableMerchantUsecase usecase;
  ...
  public long approximatedItems(
      final StepContext<MerchantDisableAllInBatchCommand, MerchantPaginableBatch> context) {
  ...
  public void write(final List<Merchant> items,
      final StepContext<MerchantDisableAllInBatchCommand, MerchantPaginableBatch> context) {
    items.forEach(item -> usecase.disable(context.getParams(), item));
  }
}
