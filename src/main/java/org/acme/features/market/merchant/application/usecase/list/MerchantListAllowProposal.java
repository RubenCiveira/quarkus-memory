...
public class MerchantListAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static MerchantListAllowProposal build(final Interaction query, final boolean allowed) {
  ...
  public static MerchantListAllowProposal build(final Interaction query, final boolean allowed,
      final String reason) {
    return MerchantListAllowProposal.builder().query(query)
   ...
   * @return
   */
  public static Allow resolveWith(final Event<MerchantListAllowProposal> emitter,
      final MerchantListAllowProposal allow) {
    emitter.fire(allow);
  ...
  public static Allow resolveWith(final Event<MerchantListAllowProposal> emitter,
    ...
    return resolveWith(emitter, MerchantListAllowProposal.build(query, allowed));
  }
