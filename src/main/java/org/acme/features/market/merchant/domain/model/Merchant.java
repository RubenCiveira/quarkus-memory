...
public class Merchant implements MerchantRef {
  ...
  public static class MerchantBuilder {
     ...
     * @return
     */
    public MerchantBuilder keyCypheredValue(final String key) {
      return key(MerchantKeyVO.fromCyphered(key));
    }
   ...
   * @return
   */
  public Optional<String> getKeyPlainValue() {
    return getKey().getPlainValue();
  }
