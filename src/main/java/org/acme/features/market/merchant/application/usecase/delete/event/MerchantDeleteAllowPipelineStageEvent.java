package org.acme.features.market.merchant.application.usecase.delete.event;
...
public class MerchantDeleteAllowPipelineStageEvent extends AllowPipelineStageEvent {
   ...
   * @return
   */
  public static MerchantDeleteAllowPipelineStageEvent build(final Interaction query,
  ...
  public static MerchantDeleteAllowPipelineStageEvent build(final Interaction query,
    ...
    return MerchantDeleteAllowPipelineStageEvent.builder().query(query)
