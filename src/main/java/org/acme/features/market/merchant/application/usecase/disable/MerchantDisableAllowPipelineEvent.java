...
public class MerchantDisableAllowPipelineEvent extends AllowPipelineEvent {
   ...
   * @return
   */
  public static MerchantDisableAllowPipelineEvent build(final Interaction query,
  ...
  public static MerchantDisableAllowPipelineEvent build(final Interaction query,
    ...
    return MerchantDisableAllowPipelineEvent.builder().query(query)
