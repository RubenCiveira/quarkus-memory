package org.acme.features.market.merchant.application.usecase.update.event;
...
public class MerchantUpdateAllowPipelineStageEvent extends AllowPipelineStageEvent {
   ...
   * @return
   */
  public static MerchantUpdateAllowPipelineStageEvent build(final Interaction query,
  ...
  public static MerchantUpdateAllowPipelineStageEvent build(final Interaction query,
    ...
    return MerchantUpdateAllowPipelineStageEvent.builder().query(query)
