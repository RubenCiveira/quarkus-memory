...
public class MerchantDisableAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static MerchantDisableAllowProposal build(final Interaction query,
  ...
  public static MerchantDisableAllowProposal build(final Interaction query,
    ...
    return MerchantDisableAllowProposal.builder().query(query).reference(reference.orElse(null))
   ...
   * @return
   */
  public static Allow resolveWith(final Event<MerchantDisableAllowProposal> emitter,
      final MerchantDisableAllowProposal allow) {
    emitter.fire(allow);
