...
import org.acme.features.market.merchant.application.service.event.MerchantFixedFieldsPipelineEvent;
import org.acme.features.market.merchant.application.service.event.MerchantHiddenFieldsPipelineEvent;
import org.acme.features.market.merchant.application.service.event.MerchantVisibilityQueryPipelineEvent;
import org.acme.features.market.merchant.application.service.event.MerchantVisibleContentPipelineEvent;
...
public class MerchantsVisibilityService {
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<MerchantFixedFieldsPipelineEvent> fireFix;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<MerchantHiddenFieldsPipelineEvent> fireHide;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<MerchantVisibilityQueryPipelineEvent> fireVisibleFilter;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<MerchantVisibleContentPipelineEvent> fireVisibleList;
  ...
  public Set<String> fieldsToFix(Interaction prev) {
    ...
    MerchantFixedFieldsPipelineEvent value =
        MerchantFixedFieldsPipelineEvent.builder().fields(fields).query(prev).build();
    fireFix.fire(value);
  ...
  public Set<String> fieldsToFix(Interaction prev, MerchantRef merchant) {
    ...
    fields.addAll(aggregate.calcultadFields());
    MerchantFixedFieldsPipelineEvent value = MerchantFixedFieldsPipelineEvent.builder()
  ...
  public Set<String> fieldsToHide(Interaction prev) {
    ...
    MerchantHiddenFieldsPipelineEvent value =
        MerchantHiddenFieldsPipelineEvent.builder().fields(fields).query(prev).build();
    fireHide.fire(value);
    return value.getFields();
  }
  ...
  public Set<String> fieldsToHide(Interaction prev, MerchantRef merchant) {
    Set<String> fields = new HashSet<>();
    MerchantHiddenFieldsPipelineEvent value = MerchantHiddenFieldsPipelineEvent.builder()
        .fields(fields).merchant(merchant).query(prev).build();
    fireHide.fire(value);
    return value.getFields();
  }
  ...
  private MerchantFilter applyPreVisibilityFilter(Interaction prev, MerchantFilter filter) {
    MerchantVisibilityQueryPipelineEvent visible =
        MerchantVisibilityQueryPipelineEvent.builder().filter(filter).interaction(prev).build();
  ...
  private boolean evaluatePostVisibility(Interaction prev, Merchant merchantRef) {
    MerchantVisibleContentPipelineEvent accesible = MerchantVisibleContentPipelineEvent.builder()
