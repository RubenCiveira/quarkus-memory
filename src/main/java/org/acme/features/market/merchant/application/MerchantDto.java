...
public class MerchantDto {
   ...
   * @return
   */
  private static Map<String, BiConsumer<MerchantDto, Merchant>> toFixCallbacks() {
   ...
   * @return
   */
  private static Map<String, Consumer<MerchantDto>> toHideCallbacks() {
  ...
  public void fixField(final String field, final Merchant merchant) {
    Map<String, BiConsumer<MerchantDto, Merchant>> toFix = toFixCallbacks();
  ...
  public void hideField(final String field) {
    Map<String, Consumer<MerchantDto>> toHide = toHideCallbacks();
