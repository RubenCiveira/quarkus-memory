...
public class MerchantRetrieveAllow extends AllowResult {
   ...
   * @return
   */
  public static MerchantRetrieveAllow build(final Interaction query,
  ...
  public static MerchantRetrieveAllow build(final Interaction query,
    ...
    return MerchantRetrieveAllow.builder().query(query).reference(reference.orElse(null))
