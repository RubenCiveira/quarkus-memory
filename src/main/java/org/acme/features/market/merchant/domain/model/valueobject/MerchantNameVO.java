...
public class MerchantNameVO {
   ...
   */
  public static MerchantNameVO from(final String name) {
    return tryFrom(name);
  }
   ...
   * @return An empty instance
   */
  public static MerchantNameVO tryFrom(final Object name) {
    ConstraintFailList list = new ConstraintFailList();
    MerchantNameVO result = tryFrom(name, list);
    if (list.hasErrors()) {
   ...
   * @return An empty instance
   */
  public static MerchantNameVO tryFrom(final Object name, final ConstraintFailList fails) {
    if (null == name) {
      fails.add(new ConstraintFail("not-null", "name", null, "Cant be null"));
      return null;
    } else if (name instanceof String) {
      return new MerchantNameVO((String) name);
    } else {
