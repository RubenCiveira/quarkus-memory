...
public class MerchantCreateAllow extends AllowResult {
   ...
   * @return
   */
  public static MerchantCreateAllow build(final Interaction query, final boolean allowed) {
  ...
  public static MerchantCreateAllow build(final Interaction query, final boolean allowed,
      final String reason) {
    return MerchantCreateAllow.builder().query(query).detail(CompletableFuture
