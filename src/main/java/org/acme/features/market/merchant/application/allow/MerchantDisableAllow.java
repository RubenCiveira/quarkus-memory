...
public class MerchantDisableAllow {
   ...
   * @return
   */
  public static MerchantDisableAllow build(final Optional<MerchantRef> reference,
  ...
  public static MerchantDisableAllow build(final Optional<MerchantRef> reference,
    ...
    return MerchantDisableAllow.builder().reference(reference.orElse(null)).detail(CompletableFuture
