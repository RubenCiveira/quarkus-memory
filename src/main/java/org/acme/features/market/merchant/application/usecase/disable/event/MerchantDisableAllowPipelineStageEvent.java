package org.acme.features.market.merchant.application.usecase.disable.event;
...
public class MerchantDisableAllowPipelineStageEvent extends AllowPipelineStageEvent {
   ...
   * @return
   */
  public static MerchantDisableAllowPipelineStageEvent build(final Interaction query,
  ...
  public static MerchantDisableAllowPipelineStageEvent build(final Interaction query,
    ...
    return MerchantDisableAllowPipelineStageEvent.builder().query(query)
