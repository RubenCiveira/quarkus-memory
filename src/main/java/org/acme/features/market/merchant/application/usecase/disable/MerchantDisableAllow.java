...
public class MerchantDisableAllow extends AllowResult {
   ...
   * @return
   */
  public static MerchantDisableAllow build(final Interaction query,
  ...
  public static MerchantDisableAllow build(final Interaction query,
    ...
    return MerchantDisableAllow.builder().query(query).reference(reference.orElse(null))
