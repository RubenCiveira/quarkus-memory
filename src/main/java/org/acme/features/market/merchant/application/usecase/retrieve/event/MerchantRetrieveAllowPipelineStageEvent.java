package org.acme.features.market.merchant.application.usecase.retrieve.event;
...
public class MerchantRetrieveAllowPipelineStageEvent extends AllowPipelineStageEvent {
   ...
   * @return
   */
  public static MerchantRetrieveAllowPipelineStageEvent build(final Interaction query,
  ...
  public static MerchantRetrieveAllowPipelineStageEvent build(final Interaction query,
    ...
    return MerchantRetrieveAllowPipelineStageEvent.builder().query(query)
