...
public class MerchantEnableAllow extends AllowResult {
   ...
   * @return
   */
  public static MerchantEnableAllow build(final Interaction query,
  ...
  public static MerchantEnableAllow build(final Interaction query,
    ...
    return MerchantEnableAllow.builder().query(query).reference(reference.orElse(null))
