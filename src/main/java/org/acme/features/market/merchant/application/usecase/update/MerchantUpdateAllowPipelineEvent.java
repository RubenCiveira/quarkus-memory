...
public class MerchantUpdateAllowPipelineEvent extends AllowPipelineEvent {
   ...
   * @return
   */
  public static MerchantUpdateAllowPipelineEvent build(final Interaction query,
  ...
  public static MerchantUpdateAllowPipelineEvent build(final Interaction query,
    ...
    return MerchantUpdateAllowPipelineEvent.builder().query(query).reference(reference.orElse(null))
