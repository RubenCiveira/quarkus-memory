...
public class MerchantUidVO {
   ...
   */
  public static MerchantUidVO from(final String uid) {
    return tryFrom(uid);
  }
   ...
   * @return An empty instance
   */
  public static MerchantUidVO tryFrom(final Object uid) {
    ConstraintFailList list = new ConstraintFailList();
    MerchantUidVO result = tryFrom(uid, list);
    if (list.hasErrors()) {
   ...
   * @return An empty instance
   */
  public static MerchantUidVO tryFrom(final Object uid, final ConstraintFailList fails) {
    if (null == uid) {
      fails.add(new ConstraintFail("not-null", "uid", null, "Cant be null"));
      return null;
    } else if (uid instanceof String) {
      return new MerchantUidVO((String) uid);
    } else {
