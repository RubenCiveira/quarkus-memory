...
public class RetrieveMerchantUsecase {
   ...
   */
  private final Event<MerchantRetrieveAllowProposal> retrieveAllow;
  ...
  public Allow allow(final Interaction query, final MerchantRef reference) {
    MerchantRetrieveAllowProposal base = MerchantRetrieveAllowProposal.build(query,
  ...
  public Allow allow(final Interaction query) {
    MerchantRetrieveAllowProposal base =
        MerchantRetrieveAllowProposal.build(query, Optional.empty(), true, "Allowed by default");
    retrieveAllow.fire(base);
    return base.getDetail();
  }
