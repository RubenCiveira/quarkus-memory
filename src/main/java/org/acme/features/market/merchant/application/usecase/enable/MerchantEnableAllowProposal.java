...
public class MerchantEnableAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static MerchantEnableAllowProposal build(final Interaction query,
  ...
  public static MerchantEnableAllowProposal build(final Interaction query,
    ...
    return MerchantEnableAllowProposal.builder().query(query).reference(reference.orElse(null))
   ...
   * @return
   */
  public static Allow resolveWith(final Event<MerchantEnableAllowProposal> emitter,
      final MerchantEnableAllowProposal allow) {
    emitter.fire(allow);
