...
public class MerchantEnableAllow {
   ...
   * @return
   */
  public static MerchantEnableAllow build(final Optional<MerchantRef> reference,
  ...
  public static MerchantEnableAllow build(final Optional<MerchantRef> reference,
    ...
    return MerchantEnableAllow.builder().reference(reference.orElse(null)).detail(CompletableFuture
