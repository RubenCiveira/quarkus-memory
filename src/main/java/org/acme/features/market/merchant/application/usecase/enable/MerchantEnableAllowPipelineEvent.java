...
public class MerchantEnableAllowPipelineEvent extends AllowPipelineEvent {
   ...
   * @return
   */
  public static MerchantEnableAllowPipelineEvent build(final Interaction query,
  ...
  public static MerchantEnableAllowPipelineEvent build(final Interaction query,
    ...
    return MerchantEnableAllowPipelineEvent.builder().query(query).reference(reference.orElse(null))
