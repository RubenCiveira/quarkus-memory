...
public class MerchantUpdateAllow {
   ...
   * @return
   */
  public static MerchantUpdateAllow build(final Optional<MerchantRef> reference,
  ...
  public static MerchantUpdateAllow build(final Optional<MerchantRef> reference,
    ...
    return MerchantUpdateAllow.builder().reference(reference.orElse(null)).detail(CompletableFuture
