...
public class RetrieveVerifyUsecase {
   ...
   */
  private final Event<VerifyRetrieveAllowPipelineEvent> retrieveAllow;
  ...
  public Allow allow(final Interaction query, final VerifyRef reference) {
    VerifyRetrieveAllowPipelineEvent base = VerifyRetrieveAllowPipelineEvent.build(query,
  ...
  public Allow allow(final Interaction query) {
    VerifyRetrieveAllowPipelineEvent base =
        VerifyRetrieveAllowPipelineEvent.build(query, Optional.empty(), true, "Allowed by default");
    retrieveAllow.fire(base);
    return base.getDetail();
  }
