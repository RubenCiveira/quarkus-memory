...
public class VerifyCreateAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static VerifyCreateAllowProposal build(final Interaction query, final boolean allowed) {
  ...
  public static VerifyCreateAllowProposal build(final Interaction query, final boolean allowed,
      final String reason) {
    return VerifyCreateAllowProposal.builder().query(query)
   ...
   * @return
   */
  public static Allow resolveWith(final Event<VerifyCreateAllowProposal> emitter,
      final VerifyCreateAllowProposal allow) {
    emitter.fire(allow);
  ...
  public static Allow resolveWith(final Event<VerifyCreateAllowProposal> emitter,
    ...
    return resolveWith(emitter, VerifyCreateAllowProposal.build(query, allowed));
  }
