...
public abstract class VerifyModifyProposal {
  ...
  public static VerifyDto resolveWith(final Event<? extends VerifyModifyProposal> emitter,
      final VerifyModifyProposal proposal) {
    ((Event<VerifyModifyProposal>) emitter).fire(proposal);
