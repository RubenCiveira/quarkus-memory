...
public class UpdateVerifyUsecase {
   ...
   * @autogenerated UpdateUsecaseGenerator
   */
  private final Event<VerifyUpdateAllow> updateAllow;
   ...
   * @return
   */
  public VerifyUpdateAllow allow(final Interaction query, final VerifyRef reference) {
    VerifyUpdateAllow base =
        VerifyUpdateAllow.build(query, Optional.of(reference), true, "Allowed by default");
   ...
   * @return
   */
  public VerifyUpdateAllow allow(final Interaction query) {
    VerifyUpdateAllow base =
        VerifyUpdateAllow.build(query, Optional.empty(), true, "Allowed by default");
    updateAllow.fire(base);
    return base;
  }
   ...
   * @return
   */
  public VerifyUpdateAllow allow() {
    return null;
  }
