...
public class VerifyUpdateAllow extends AllowResult {
   ...
   * @return
   */
  public static VerifyUpdateAllow build(final Interaction query,
  ...
  public static VerifyUpdateAllow build(final Interaction query,
    ...
    return VerifyUpdateAllow.builder().query(query).reference(reference.orElse(null))
