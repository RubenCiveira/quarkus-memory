...
public class VerifyListAllow extends AllowResult {
   ...
   * @return
   */
  public static VerifyListAllow build(final Interaction query, final boolean allowed) {
  ...
  public static VerifyListAllow build(final Interaction query, final boolean allowed,
      final String reason) {
    return VerifyListAllow.builder().query(query).detail(CompletableFuture
