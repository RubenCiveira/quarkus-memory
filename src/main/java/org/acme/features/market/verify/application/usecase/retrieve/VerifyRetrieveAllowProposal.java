...
public class VerifyRetrieveAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static VerifyRetrieveAllowProposal build(final Interaction query,
  ...
  public static VerifyRetrieveAllowProposal build(final Interaction query,
    ...
    return VerifyRetrieveAllowProposal.builder().query(query).reference(reference.orElse(null))
   ...
   * @return
   */
  public static Allow resolveWith(final Event<VerifyRetrieveAllowProposal> emitter,
      final VerifyRetrieveAllowProposal allow) {
    emitter.fire(allow);
