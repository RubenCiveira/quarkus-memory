...
import org.acme.features.market.verify.application.usecase.delete.VerifyCheckBatchDeleteStatusQuery;
import org.acme.features.market.verify.application.usecase.delete.VerifyDeleteAllInBatchCommand;
...
public class VerifyController implements VerifyApi {
   ...
   */
  @Override
  public Response verifyApiBatchDelete(final List<String> uids, final String search,
      final String name) {
    ...
    BatchIdentificator task = delete.delete(
        VerifyDeleteAllInBatchCommand.builder().filter(filter).build(currentRequest.interaction()));
   ...
   */
  @Override
  public Response verifyApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(VerifyCheckBatchDeleteStatusQuery.builder()
  ...
  public Response verifyApiList(final List<String> uids, final String search, final String name,
    ...
    return currentRequest.cacheableResponse(listed, toListApiModel(listed, filter, cursor),
        "verify-" + String.valueOf(("" + filter + cursor).hashCode()));
  }
