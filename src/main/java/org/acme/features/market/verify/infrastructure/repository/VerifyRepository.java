...
public class VerifyRepository {
   ...
   * @return
   */
  public long count(VerifyFilter filter) {
   ...
   * @return
   */
  private <T> SqlSchematicQuery<T> filteredQuery(SqlTemplate template, VerifyFilter filter) {
    SqlSchematicQuery<T> sq = template.createSqlSchematicQuery("verify");
    sq.selectFields("verify.uid", "verify.name", "verify.version");
    sq.child(100, "medals",
