...
public class VerifyDto {
   ...
   * @return
   */
  private static Map<String, BiConsumer<VerifyDto, Verify>> buildToFix() {
   ...
   * @return
   */
  private static Map<String, Consumer<VerifyDto>> buildToHide() {
  ...
  public void fixField(final String field, final Verify verify) {
    Map<String, BiConsumer<VerifyDto, Verify>> toFix = buildToFix();
  ...
  public void hideField(final String field) {
    Map<String, Consumer<VerifyDto>> toHide = buildToHide();
