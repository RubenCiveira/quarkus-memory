...
public class VerifyDto {
   ...
   * @return
   */
  private static Map<String, BiConsumer<VerifyDto, Verify>> toFixCallbacks() {
    Map<String, BiConsumer<VerifyDto, Verify>> map = new HashMap<>();
    ...
    map.put("medals",
        (target, source) -> target.medals = source == null ? null : source.getMedals());
    map.put("version",
   ...
   * @return
   */
  private static Map<String, Consumer<VerifyDto>> toHideCallbacks() {
    Map<String, Consumer<VerifyDto>> map = new HashMap<>();
    map.put("uid", dto -> dto.uid = null);
    map.put("name", dto -> dto.name = null);
    map.put("medals", dto -> dto.medals = null);
  ...
  public void fixField(final String field, final Verify verify) {
    Map<String, BiConsumer<VerifyDto, Verify>> toFix = toFixCallbacks();
  ...
  public void hideField(final String field) {
    Map<String, Consumer<VerifyDto>> toHide = toHideCallbacks();
