...
public class VerifyDto {
   ...
   * @autogenerated EntityGenerator
   */
  private static final Map<String, Consumer<VerifyDto>> toHide = Map.of("uid",
      dto -> dto.uid = null, "name", dto -> dto.name = null, "version", dto -> dto.version = null);
  ...
  public static VerifyDto from(final Verify verify) {
    return VerifyDto.builder().uid(verify.getUid()).name(verify.getName())
        .version(verify.getVersion()).build();
  }
