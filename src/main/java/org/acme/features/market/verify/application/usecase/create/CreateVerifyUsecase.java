...
public class CreateVerifyUsecase {
   ...
   * @autogenerated CreateUsecaseGenerator
   */
  private final Event<VerifyCreateAllow> createAllow;
   ...
   * @return
   */
  public VerifyCreateAllow allow(final Interaction query) {
    VerifyCreateAllow base = VerifyCreateAllow.build(query, true, "Allowed by default");
  ...
  public CompletionStage<VerifyCreateResult> create(final VerifyCreateCommand query) {
    CompletionStage<Optional<Verify>> create = allow(query).getDetail().thenCompose(detail -> {
      if (!detail.isAllowed()) {
