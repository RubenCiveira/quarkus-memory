...
public class VerifyUpdateAllowPipelineEvent extends AllowPipelineEvent {
   ...
   * @return
   */
  public static VerifyUpdateAllowPipelineEvent build(final Interaction query,
  ...
  public static VerifyUpdateAllowPipelineEvent build(final Interaction query,
    ...
    return VerifyUpdateAllowPipelineEvent.builder().query(query).reference(reference.orElse(null))
