...
public class VerifyCreateAllow extends AllowResult {
   ...
   * @return
   */
  public static VerifyCreateAllow build(final Interaction query, final boolean allowed) {
  ...
  public static VerifyCreateAllow build(final Interaction query, final boolean allowed,
      final String reason) {
    return VerifyCreateAllow.builder().query(query).detail(CompletableFuture
