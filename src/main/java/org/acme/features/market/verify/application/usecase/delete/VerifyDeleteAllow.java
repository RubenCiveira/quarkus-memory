...
public class VerifyDeleteAllow extends AllowResult {
   ...
   * @return
   */
  public static VerifyDeleteAllow build(final Interaction query,
  ...
  public static VerifyDeleteAllow build(final Interaction query,
    ...
    return VerifyDeleteAllow.builder().query(query).reference(reference.orElse(null))
