...
import org.acme.features.market.verify.application.service.event.VerifyFixedFields;
import org.acme.features.market.verify.application.service.event.VerifyHiddenFields;
import org.acme.features.market.verify.application.service.event.VerifyVisibilityQuery;
import org.acme.features.market.verify.application.service.event.VerifyVisibleContent;
...
public class VerifysVisibilityService {
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<VerifyFixedFields> fireFix;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<VerifyHiddenFields> fireHide;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<VerifyVisibilityQuery> fireVisibleFilter;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<VerifyVisibleContent> fireVisibleList;
   ...
   */
  public VerifyFixedFields fieldsToFix(Interaction prev) {
    ...
    VerifyFixedFields value = VerifyFixedFields.builder().fixed(fields).build(prev);
    fireFix.fire(value);
    return value;
  }
   ...
   * @return initialsFixFields
   */
  public VerifyFixedFields fieldsToFix(Interaction prev, VerifyRef verify) {
    ...
    VerifyFixedFields value = VerifyFixedFields.builder().fixed(fields).verify(verify).build(prev);
    fireFix.fire(value);
    return value;
  }
   ...
   */
  public VerifyHiddenFields fieldsToHide(Interaction prev) {
    CompletionStage<Set<String>> fields = CompletableFuture.completedFuture(Set.of());
    VerifyHiddenFields value = VerifyHiddenFields.builder().hidden(fields).build(prev);
    fireHide.fire(value);
    return value;
  }
   ...
   * @return initialsHideFields
   */
  public VerifyHiddenFields fieldsToHide(Interaction prev, VerifyRef verify) {
    CompletionStage<Set<String>> fields = fieldsToHide(prev).getHidden();
    VerifyHiddenFields value =
        VerifyHiddenFields.builder().hidden(fields).verify(verify).build(prev);
    fireHide.fire(value);
    return value;
  }
  ...
  private CompletionStage<VerifyFilter> applyPreVisibilityFilter(Interaction prev,
      VerifyFilter filter) {
    VerifyVisibilityQuery visible = VerifyVisibilityQuery.builder()
  ...
  private CompletionStage<List<Verify>> evaluatePostVisibility(Interaction prev,
    ...
    VerifyVisibleContent list = VerifyVisibleContent.builder()
        .visibles(CompletableFuture.completedFuture(new ArrayList<>(verifyRefs))).build(prev);
