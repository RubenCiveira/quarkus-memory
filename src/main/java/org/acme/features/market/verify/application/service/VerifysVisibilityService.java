...
import org.acme.features.market.verify.application.service.event.VerifyFixedFieldsPipelineEvent;
import org.acme.features.market.verify.application.service.event.VerifyHiddenFieldsPipelineEvent;
import org.acme.features.market.verify.application.service.event.VerifyVisibilityQueryPipelineEvent;
import org.acme.features.market.verify.application.service.event.VerifyVisibleContentPipelineEvent;
...
public class VerifysVisibilityService {
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<VerifyFixedFieldsPipelineEvent> fireFix;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<VerifyHiddenFieldsPipelineEvent> fireHide;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<VerifyVisibilityQueryPipelineEvent> fireVisibleFilter;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<VerifyVisibleContentPipelineEvent> fireVisibleList;
   ...
   * @return The input entity with the copy values without hidden
   */
  public VerifyDto copyWithFixed(Interaction prev, Verify original, VerifyDto source) {
    ...
    return formula.copyWithFormulas(prev, original, withReferences);
  }
  ...
  public Set<String> fieldsToFix(Interaction prev) {
    ...
    VerifyFixedFieldsPipelineEvent value =
        VerifyFixedFieldsPipelineEvent.builder().fields(fields).query(prev).build();
    fireFix.fire(value);
  ...
  public Set<String> fieldsToFix(Interaction prev, VerifyRef verify) {
    ...
    fields.addAll(aggregate.calcultadFields());
    VerifyFixedFieldsPipelineEvent value =
        VerifyFixedFieldsPipelineEvent.builder().fields(fields).verify(verify).query(prev).build();
    fireFix.fire(value);
    return value.getFields();
  }
  ...
  public Set<String> fieldsToHide(Interaction prev) {
    ...
    VerifyHiddenFieldsPipelineEvent value =
        VerifyHiddenFieldsPipelineEvent.builder().fields(fields).query(prev).build();
    fireHide.fire(value);
    return value.getFields();
  }
  ...
  public Set<String> fieldsToHide(Interaction prev, VerifyRef verify) {
    Set<String> fields = new HashSet<>();
    VerifyHiddenFieldsPipelineEvent value =
        VerifyHiddenFieldsPipelineEvent.builder().fields(fields).verify(verify).query(prev).build();
    fireHide.fire(value);
    return value.getFields();
  }
  ...
  private VerifyFilter applyPreVisibilityFilter(Interaction prev, VerifyFilter filter) {
    VerifyVisibilityQueryPipelineEvent visible =
        VerifyVisibilityQueryPipelineEvent.builder().filter(filter).interaction(prev).build();
  ...
  private boolean evaluatePostVisibility(Interaction prev, Verify verifyRef) {
    VerifyVisibleContentPipelineEvent accesible = VerifyVisibleContentPipelineEvent.builder()
        .visible(true).entity(verifyRef).interaction(prev).build();
