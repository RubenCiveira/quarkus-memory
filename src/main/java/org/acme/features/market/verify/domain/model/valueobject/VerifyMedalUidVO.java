...
public class VerifyMedalUidVO {
   ...
   */
  public static VerifyMedalUidVO from(final String uid) {
    return tryFrom(uid);
  }
   ...
   * @return An empty instance
   */
  public static VerifyMedalUidVO tryFrom(final Object uid) {
    ConstraintFailList list = new ConstraintFailList();
    VerifyMedalUidVO result = tryFrom(uid, list);
    if (list.hasErrors()) {
   ...
   * @return An empty instance
   */
  public static <T extends AbstractFailList> VerifyMedalUidVO tryFrom(final Object uid,
      final T fails) {
    if (null == uid) {
      fails.add(new ConstraintFail("not-null", "uid", null, "Cant be null"));
      return null;
    } else if (uid instanceof String) {
      return new VerifyMedalUidVO((String) uid);
    } else {
