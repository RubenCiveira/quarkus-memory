...
public class RetrievePhotoUploadUsecase {
   ...
   */
  private final Event<PlacePhotoRetrieveUploadAllowPipelineEvent> retrieveAllow;
  ...
  public Allow allow(final Interaction query, final PlaceRef reference) {
    PlacePhotoRetrieveUploadAllowPipelineEvent base = PlacePhotoRetrieveUploadAllowPipelineEvent
