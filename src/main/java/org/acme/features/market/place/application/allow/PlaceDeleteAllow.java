...
public class PlaceDeleteAllow {
   ...
   * @return
   */
  public static PlaceDeleteAllow build(final Optional<PlaceRef> reference, final boolean allowed) {
  ...
  public static PlaceDeleteAllow build(final Optional<PlaceRef> reference, final boolean allowed,
      final String reason) {
    return PlaceDeleteAllow.builder().reference(reference.orElse(null)).detail(CompletableFuture
