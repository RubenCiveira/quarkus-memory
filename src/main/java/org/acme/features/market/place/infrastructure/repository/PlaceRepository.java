...
public class PlaceRepository {
   ...
   * @return
   */
  private <T> SqlSchematicQuery<T> filteredQuery(SqlTemplate template, PlaceFilter filter) {
    SqlSchematicQuery<T> sq = template.createSqlSchematicQuery("place");
    sq.selectFields("place.uid", "place.name", "place.merchant", "place.photo",
        "place.opening_date", "place.version");
