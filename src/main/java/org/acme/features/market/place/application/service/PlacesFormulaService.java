...
public class PlacesFormulaService {
   ...
   */
  private final Event<PlaceFormulaBuilderPipelineEvent> formulaBuilder;
   ...
   */
  public PlaceDto copyWithFormulas(Interaction prev, Place original, PlaceDto source) {
    PlaceFormulaBuilderPipelineEvent formulas = PlaceFormulaBuilderPipelineEvent.builder()
  ...
  public PlaceDto copyWithFormulas(Interaction prev, PlaceDto source) {
    PlaceFormulaBuilderPipelineEvent formulas =
        PlaceFormulaBuilderPipelineEvent.builder().dto(source).interaction(prev).build();
    formulaBuilder.fire(formulas);
    return formulas.getDto();
  }
}
