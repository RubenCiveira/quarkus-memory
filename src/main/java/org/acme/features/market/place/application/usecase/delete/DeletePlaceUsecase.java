...
public class DeletePlaceUsecase {
   ...
   * @return
   */
  public PlaceDeleteAllow allow(final Interaction query, final PlaceRef reference) {
    PlaceDeleteAllow base =
        PlaceDeleteAllow.build(query, Optional.of(reference), true, "Allowed by default");
   ...
   * @return
   */
  public PlaceDeleteAllow allow(final Interaction query) {
    PlaceDeleteAllow base =
        PlaceDeleteAllow.build(query, Optional.empty(), true, "Allowed by default");
    deleteAllow.fire(base);
    return base;
  }
