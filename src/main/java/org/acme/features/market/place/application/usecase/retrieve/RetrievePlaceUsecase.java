...
public class RetrievePlaceUsecase {
   ...
   */
  private final Event<PlaceRetrieveAllowPipelineEvent> retrieveAllow;
  ...
  public Allow allow(final Interaction query, final PlaceRef reference) {
    PlaceRetrieveAllowPipelineEvent base = PlaceRetrieveAllowPipelineEvent.build(query,
  ...
  public Allow allow(final Interaction query) {
    PlaceRetrieveAllowPipelineEvent base =
        PlaceRetrieveAllowPipelineEvent.build(query, Optional.empty(), true, "Allowed by default");
    retrieveAllow.fire(base);
    return base.getDetail();
  }
