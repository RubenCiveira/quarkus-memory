...
public class ListPlaceUsecase {
   ...
   */
  private final Event<PlaceListAllowProposal> listAllow;
  ...
  public Allow allow(final Interaction query) {
    PlaceListAllowProposal base = PlaceListAllowProposal.build(query, true, "Allowed by default");
    listAllow.fire(base);
  ...
  public List<PlaceDto> list(final PlaceListQuery query) {
    ...
    return new TimestampedList<>(WrapMetadata.<List<PlaceDto>>builder().data(list)
