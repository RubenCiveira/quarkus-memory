...
public class PlaceUpdateAllow {
   ...
   * @return
   */
  public static PlaceUpdateAllow build(final Optional<PlaceRef> reference, final boolean allowed) {
  ...
  public static PlaceUpdateAllow build(final Optional<PlaceRef> reference, final boolean allowed,
      final String reason) {
    return PlaceUpdateAllow.builder().reference(reference.orElse(null)).detail(CompletableFuture
