...
public class UpdatePlaceUsecase {
   ...
   * @autogenerated UpdateUsecaseGenerator
   */
  private final Event<PlaceUpdateAllowPipelineEvent> updateAllow;
  ...
  public Allow allow(final Interaction query, final PlaceRef reference) {
    PlaceUpdateAllowPipelineEvent base = PlaceUpdateAllowPipelineEvent.build(query,
  ...
  public Allow allow(final Interaction query) {
    PlaceUpdateAllowPipelineEvent base =
        PlaceUpdateAllowPipelineEvent.build(query, Optional.empty(), true, "Allowed by default");
    updateAllow.fire(base);
    return base.getDetail();
  }
  ...
  public PlaceDto update(final PlaceUpdateCommand command) {
    ...
    PlaceDto dto = visibility.copyWithFixed(command, command.getDto());
