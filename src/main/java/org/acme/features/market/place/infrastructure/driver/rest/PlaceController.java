...
import org.acme.features.market.place.application.usecase.delete.PlaceCheckBatchDeleteStatusQuery;
import org.acme.features.market.place.application.usecase.delete.PlaceDeleteAllInBatchCommand;
...
import org.acme.features.market.place.application.usecase.photoretrieve.PlaceRetrieveUploadPhotoQuery;
import org.acme.features.market.place.application.usecase.photoretrieve.RetrievePhotoUploadUsecase;
import org.acme.features.market.place.application.usecase.photoupload.PhotoTemporalUploadUsecase;
import org.acme.features.market.place.application.usecase.photoupload.PlacePhotoTemporalUploadCommand;
import org.acme.features.market.place.application.usecase.photoupload.PlacePhotoTemporalUploadReadQuery;
...
public class PlaceController implements PlaceApi {
   ...
   */
  @Override
  public Response placeApiBatchDelete(final List<String> uids, final String search,
    ...
    BatchIdentificator task = delete.delete(
        PlaceDeleteAllInBatchCommand.builder().filter(filter).build(currentRequest.interaction()));
   ...
   */
  @Override
  public Response placeApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(PlaceCheckBatchDeleteStatusQuery.builder()
  ...
  public Response placeApiList(final List<String> uids, final String search, final String name,
    ...
    return currentRequest.cacheableResponse(listed, toListApiModel(listed, filter, cursor),
        "place-" + String.valueOf(("" + filter + cursor).hashCode()));
  }
