...
public class PlaceDto {
   ...
   * @return
   */
  private static Map<String, BiConsumer<PlaceDto, Place>> buildToFix() {
   ...
   * @return
   */
  private static Map<String, Consumer<PlaceDto>> buildToHide() {
  ...
  public void fixField(final String field, final Place place) {
    Map<String, BiConsumer<PlaceDto, Place>> toFix = buildToFix();
  ...
  public void hideField(final String field) {
    Map<String, Consumer<PlaceDto>> toHide = buildToHide();
