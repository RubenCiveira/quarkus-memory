...
public interface PlaceWriteRepositoryGateway {
   ...
   */
  Place create(Place entity, Function<Place, Boolean> verifier);
   ...
   * @return Retrieve one single value
   */
  Place update(PlaceRef reference, Place entity);
}
