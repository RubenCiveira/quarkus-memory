...
import org.acme.features.market.place.application.service.event.PlaceHiddenFieldsPipelineEvent;
import org.acme.features.market.place.application.service.event.PlaceVisibilityQueryPipelineEvent;
import org.acme.features.market.place.application.service.event.PlaceVisibleContentPipelineEvent;
...
public class PlacesVisibilityService {
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<PlaceFixedFieldsPipelineEvent> fireFix;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<PlaceHiddenFieldsPipelineEvent> fireHide;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<PlaceVisibilityQueryPipelineEvent> fireVisibleFilter;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<PlaceVisibleContentPipelineEvent> fireVisibleList;
   ...
   * @return The input entity with the copy values without hidden
   */
  public PlaceDto copyWithFixed(Interaction prev, Place original, PlaceDto source) {
  ...
  public Set<String> fieldsToFix(Interaction prev) {
    ...
    PlaceFixedFieldsPipelineEvent value =
        PlaceFixedFieldsPipelineEvent.builder().fields(fields).query(prev).build();
    fireFix.fire(value);
  ...
  public Set<String> fieldsToFix(Interaction prev, PlaceRef place) {
    ...
    fields.addAll(aggregate.calcultadFields());
    PlaceFixedFieldsPipelineEvent value =
        PlaceFixedFieldsPipelineEvent.builder().fields(fields).place(place).query(prev).build();
    fireFix.fire(value);
    return value.getFields();
  }
  ...
  public Set<String> fieldsToHide(Interaction prev) {
    ...
    PlaceHiddenFieldsPipelineEvent value =
        PlaceHiddenFieldsPipelineEvent.builder().fields(fields).query(prev).build();
    fireHide.fire(value);
    return value.getFields();
  }
  ...
  public Set<String> fieldsToHide(Interaction prev, PlaceRef place) {
    Set<String> fields = new HashSet<>();
    PlaceHiddenFieldsPipelineEvent value =
        PlaceHiddenFieldsPipelineEvent.builder().fields(fields).place(place).query(prev).build();
    fireHide.fire(value);
    return value.getFields();
  }
  ...
  private PlaceFilter applyPreVisibilityFilter(Interaction prev, PlaceFilter filter) {
    PlaceVisibilityQueryPipelineEvent visible =
        PlaceVisibilityQueryPipelineEvent.builder().filter(filter).interaction(prev).build();
  ...
  private boolean evaluatePostVisibility(Interaction prev, Place placeRef) {
    PlaceVisibleContentPipelineEvent accesible = PlaceVisibleContentPipelineEvent.builder()
        .visible(true).entity(placeRef).interaction(prev).build();
