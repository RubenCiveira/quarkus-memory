...
public class PlaceRetrieveAllow extends AllowResult {
   ...
   * @return
   */
  public static PlaceRetrieveAllow build(final Interaction query,
  ...
  public static PlaceRetrieveAllow build(final Interaction query,
    ...
    return PlaceRetrieveAllow.builder().query(query).reference(reference.orElse(null))
