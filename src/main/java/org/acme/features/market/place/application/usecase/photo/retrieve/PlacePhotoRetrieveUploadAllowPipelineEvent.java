...
public class PlacePhotoRetrieveUploadAllowPipelineEvent extends AllowPipelineEvent {
   ...
   * @return
   */
  public static PlacePhotoRetrieveUploadAllowPipelineEvent build(final Interaction query,
  ...
  public static PlacePhotoRetrieveUploadAllowPipelineEvent build(final Interaction query,
    ...
    return PlacePhotoRetrieveUploadAllowPipelineEvent.builder().query(query)
