...
public class PlaceUpdateAllow extends AllowResult {
   ...
   * @return
   */
  public static PlaceUpdateAllow build(final Interaction query, final Optional<PlaceRef> reference,
  ...
  public static PlaceUpdateAllow build(final Interaction query, final Optional<PlaceRef> reference,
    ...
    return PlaceUpdateAllow.builder().query(query).reference(reference.orElse(null))
