...
public class PlacePhotoRetrieveUploadAllow extends AllowResult {
   ...
   * @return
   */
  public static PlacePhotoRetrieveUploadAllow build(final Interaction query,
  ...
  public static PlacePhotoRetrieveUploadAllow build(final Interaction query,
    ...
    return PlacePhotoRetrieveUploadAllow.builder().query(query).reference(reference.orElse(null))
