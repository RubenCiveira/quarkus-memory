...
public class PhotoTemporalUploadUsecase {
   ...
   * @return
   */
  public PlacePhotoTempUploadAllow allow(final Interaction query) {
    PlacePhotoTempUploadAllow base =
        PlacePhotoTempUploadAllow.build(query, true, "Allowed by default");
