...
public class PhotoTemporalUploadUsecase {
   ...
   * @autogenerated ListUsecaseGenerator
   */
  private final Event<PlacePhotoTempUploadAllowPipelineEvent> tempUploadAllow;
  ...
  public Allow allow(final Interaction query) {
    PlacePhotoTempUploadAllowPipelineEvent base =
        PlacePhotoTempUploadAllowPipelineEvent.build(query, true, "Allowed by default");
