...
import org.acme.features.market.medal.application.service.event.MedalFormulaBuilderPipelineEvent;
...
public class MedalsFormulaService {
   ...
   */
  private final Event<MedalFormulaBuilderPipelineEvent> formulaBuilder;
   ...
   */
  public MedalDto copyWithFormulas(Interaction prev, Medal original, MedalDto source) {
    MedalFormulaBuilderPipelineEvent formulas = MedalFormulaBuilderPipelineEvent.builder()
  ...
  public MedalDto copyWithFormulas(Interaction prev, MedalDto source) {
    MedalFormulaBuilderPipelineEvent formulas =
        MedalFormulaBuilderPipelineEvent.builder().dto(source).interaction(prev).build();
    formulaBuilder.fire(formulas);
    return formulas.getDto();
  }
}
