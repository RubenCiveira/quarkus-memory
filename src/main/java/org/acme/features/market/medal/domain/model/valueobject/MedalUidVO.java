...
public class MedalUidVO {
   ...
   */
  public static MedalUidVO from(final String uid) {
    return tryFrom(uid);
  }
   ...
   * @return An empty instance
   */
  public static MedalUidVO tryFrom(final Object uid) {
    ConstraintFailList list = new ConstraintFailList();
    MedalUidVO result = tryFrom(uid, list);
    if (list.hasErrors()) {
   ...
   * @return An empty instance
   */
  public static <T extends AbstractFailList> MedalUidVO tryFrom(final Object uid, final T fails) {
    if (null == uid) {
      fails.add(new ConstraintFail("not-null", "uid", null, "Cant be null"));
      return null;
    } else if (uid instanceof String) {
      return new MedalUidVO((String) uid);
    } else {
