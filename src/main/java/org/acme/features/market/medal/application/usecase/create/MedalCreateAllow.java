...
public class MedalCreateAllow extends AllowResult {
   ...
   * @return
   */
  public static MedalCreateAllow build(final Interaction query, final boolean allowed) {
  ...
  public static MedalCreateAllow build(final Interaction query, final boolean allowed,
      final String reason) {
    return MedalCreateAllow.builder().query(query).detail(CompletableFuture
