...
public class MedalCreateAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static MedalCreateAllowProposal build(final Interaction query, final boolean allowed) {
  ...
  public static MedalCreateAllowProposal build(final Interaction query, final boolean allowed,
      final String reason) {
    return MedalCreateAllowProposal.builder().query(query)
   ...
   * @return
   */
  public static Allow resolveWith(final Event<MedalCreateAllowProposal> emitter,
      final MedalCreateAllowProposal allow) {
    emitter.fire(allow);
  ...
  public static Allow resolveWith(final Event<MedalCreateAllowProposal> emitter,
    ...
    return resolveWith(emitter, MedalCreateAllowProposal.build(query, allowed));
  }
