...
public class MedalListAllow extends AllowResult {
   ...
   * @return
   */
  public static MedalListAllow build(final Interaction query, final boolean allowed) {
  ...
  public static MedalListAllow build(final Interaction query, final boolean allowed,
      final String reason) {
    return MedalListAllow.builder().query(query).detail(CompletableFuture
