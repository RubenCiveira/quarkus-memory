...
import org.acme.features.market.medal.application.usecase.delete.MedalCheckBatchDeleteStatusQuery;
import org.acme.features.market.medal.application.usecase.delete.MedalDeleteAllInBatchCommand;
...
public class MedalController implements MedalApi {
   ...
   */
  @Override
  public Response medalApiBatchDelete(final List<String> uids, final String search,
      final String name) {
    ...
    BatchIdentificator task = delete.delete(
        MedalDeleteAllInBatchCommand.builder().filter(filter).build(currentRequest.interaction()));
   ...
   */
  @Override
  public Response medalApiBatchDeleteQuery(final String batchId) {
    BatchProgress task = delete.checkProgress(MedalCheckBatchDeleteStatusQuery.builder()
  ...
  public Response medalApiList(final List<String> uids, final String search, final String name,
    ...
    return currentRequest.cacheableResponse(listed, toListApiModel(listed, filter, cursor),
        "medal-" + String.valueOf(("" + filter + cursor).hashCode()));
  }
