...
import org.acme.features.market.medal.application.service.event.MedalFixedFields;
import org.acme.features.market.medal.application.service.event.MedalHiddenFields;
import org.acme.features.market.medal.application.service.event.MedalVisibilityQuery;
import org.acme.features.market.medal.application.service.event.MedalVisibleContent;
...
public class MedalsVisibilityService {
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<MedalFixedFields> fireFix;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<MedalHiddenFields> fireHide;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<MedalVisibilityQuery> fireVisibleFilter;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<MedalVisibleContent> fireVisibleList;
   ...
   */
  public MedalFixedFields fieldsToFix(Interaction prev) {
    ...
    MedalFixedFields value = MedalFixedFields.builder().fixed(fields).build(prev);
    fireFix.fire(value);
    return value;
  }
   ...
   * @return initialsFixFields
   */
  public MedalFixedFields fieldsToFix(Interaction prev, MedalRef medal) {
    ...
    MedalFixedFields value = MedalFixedFields.builder().fixed(fields).medal(medal).build(prev);
    fireFix.fire(value);
    return value;
  }
   ...
   */
  public MedalHiddenFields fieldsToHide(Interaction prev) {
    CompletionStage<Set<String>> fields = CompletableFuture.completedFuture(Set.of());
    MedalHiddenFields value = MedalHiddenFields.builder().hidden(fields).build(prev);
    fireHide.fire(value);
    return value;
  }
   ...
   * @return initialsHideFields
   */
  public MedalHiddenFields fieldsToHide(Interaction prev, MedalRef medal) {
    CompletionStage<Set<String>> fields = fieldsToHide(prev).getHidden();
    MedalHiddenFields value = MedalHiddenFields.builder().hidden(fields).medal(medal).build(prev);
    fireHide.fire(value);
    return value;
  }
  ...
  private CompletionStage<MedalFilter> applyPreVisibilityFilter(Interaction prev,
      MedalFilter filter) {
    MedalVisibilityQuery visible = MedalVisibilityQuery.builder()
  ...
  private CompletionStage<List<Medal>> evaluatePostVisibility(Interaction prev,
    ...
    MedalVisibleContent list = MedalVisibleContent.builder()
        .visibles(CompletableFuture.completedFuture(new ArrayList<>(medalRefs))).build(prev);
