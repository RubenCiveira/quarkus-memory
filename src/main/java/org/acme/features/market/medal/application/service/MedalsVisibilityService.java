...
import org.acme.features.market.medal.application.service.event.MedalFixedFieldsPipelineEvent;
import org.acme.features.market.medal.application.service.event.MedalHiddenFieldsPipelineEvent;
import org.acme.features.market.medal.application.service.event.MedalVisibilityQueryPipelineEvent;
import org.acme.features.market.medal.application.service.event.MedalVisibleContentPipelineEvent;
...
public class MedalsVisibilityService {
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<MedalFixedFieldsPipelineEvent> fireFix;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<MedalHiddenFieldsPipelineEvent> fireHide;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<MedalVisibilityQueryPipelineEvent> fireVisibleFilter;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<MedalVisibleContentPipelineEvent> fireVisibleList;
  ...
  public Set<String> fieldsToFix(Interaction prev) {
    ...
    MedalFixedFieldsPipelineEvent value =
        MedalFixedFieldsPipelineEvent.builder().fields(fields).query(prev).build();
    fireFix.fire(value);
  ...
  public Set<String> fieldsToFix(Interaction prev, MedalRef medal) {
    ...
    fields.addAll(aggregate.calcultadFields());
    MedalFixedFieldsPipelineEvent value =
        MedalFixedFieldsPipelineEvent.builder().fields(fields).medal(medal).query(prev).build();
    fireFix.fire(value);
    return value.getFields();
  }
  ...
  public Set<String> fieldsToHide(Interaction prev) {
    ...
    MedalHiddenFieldsPipelineEvent value =
        MedalHiddenFieldsPipelineEvent.builder().fields(fields).query(prev).build();
    fireHide.fire(value);
    return value.getFields();
  }
  ...
  public Set<String> fieldsToHide(Interaction prev, MedalRef medal) {
    Set<String> fields = new HashSet<>();
    MedalHiddenFieldsPipelineEvent value =
        MedalHiddenFieldsPipelineEvent.builder().fields(fields).medal(medal).query(prev).build();
    fireHide.fire(value);
    return value.getFields();
  }
  ...
  private MedalFilter applyPreVisibilityFilter(Interaction prev, MedalFilter filter) {
    MedalVisibilityQueryPipelineEvent visible =
        MedalVisibilityQueryPipelineEvent.builder().filter(filter).interaction(prev).build();
  ...
  private boolean evaluatePostVisibility(Interaction prev, Medal medalRef) {
    MedalVisibleContentPipelineEvent accesible = MedalVisibleContentPipelineEvent.builder()
        .visible(true).entity(medalRef).interaction(prev).build();
