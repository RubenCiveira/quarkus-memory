...
public class RetrieveMedalUsecase {
   ...
   */
  private final Event<MedalRetrieveAllow> retrieveAllow;
   ...
   * @return
   */
  public MedalRetrieveAllow allow(final Interaction query, final MedalRef reference) {
    MedalRetrieveAllow base =
        MedalRetrieveAllow.build(query, Optional.of(reference), true, "Allowed by default");
   ...
   * @return
   */
  public MedalRetrieveAllow allow(final Interaction query) {
    MedalRetrieveAllow base =
        MedalRetrieveAllow.build(query, Optional.empty(), true, "Allowed by default");
    retrieveAllow.fire(base);
    return base;
  }
