...
public class RetrieveMedalUsecase {
   ...
   */
  private final Event<MedalRetrieveAllowProposal> retrieveAllow;
  ...
  public Allow allow(final Interaction query, final MedalRef reference) {
    MedalRetrieveAllowProposal base =
        MedalRetrieveAllowProposal.build(query, Optional.of(reference), true, "Allowed by default");
  ...
  public Allow allow(final Interaction query) {
    MedalRetrieveAllowProposal base =
        MedalRetrieveAllowProposal.build(query, Optional.empty(), true, "Allowed by default");
    retrieveAllow.fire(base);
    return base.getDetail();
  }
