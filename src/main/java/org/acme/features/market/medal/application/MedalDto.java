...
public class MedalDto {
   ...
   * @return
   */
  private static Map<String, BiConsumer<MedalDto, Medal>> toFixCallbacks() {
   ...
   * @return
   */
  private static Map<String, Consumer<MedalDto>> toHideCallbacks() {
  ...
  public void fixField(final String field, final Medal medal) {
    Map<String, BiConsumer<MedalDto, Medal>> toFix = toFixCallbacks();
  ...
  public void hideField(final String field) {
    Map<String, Consumer<MedalDto>> toHide = toHideCallbacks();
