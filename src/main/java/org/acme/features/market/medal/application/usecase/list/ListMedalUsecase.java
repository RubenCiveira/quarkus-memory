...
public class ListMedalUsecase {
   ...
   */
  private final Event<MedalListAllowPipelineEvent> listAllow;
  ...
  public Allow allow(final Interaction query) {
    MedalListAllowPipelineEvent base =
        MedalListAllowPipelineEvent.build(query, true, "Allowed by default");
    listAllow.fire(base);
