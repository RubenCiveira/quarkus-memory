package org.acme.features.market.area.application.usecase.update.event;
...
public class AreaUpdateAllowPipelineStageEvent extends AllowPipelineStageEvent {
   ...
   * @return
   */
  public static AreaUpdateAllowPipelineStageEvent build(final Interaction query,
  ...
  public static AreaUpdateAllowPipelineStageEvent build(final Interaction query,
    ...
    return AreaUpdateAllowPipelineStageEvent.builder().query(query)
