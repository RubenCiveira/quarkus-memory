...
public class AreaDto {
   ...
   * @return
   */
  private static Map<String, BiConsumer<AreaDto, Area>> buildToFix() {
   ...
   * @return
   */
  private static Map<String, Consumer<AreaDto>> buildToHide() {
  ...
  public void fixField(final String field, final Area area) {
    Map<String, BiConsumer<AreaDto, Area>> toFix = buildToFix();
  ...
  public void hideField(final String field) {
    Map<String, Consumer<AreaDto>> toHide = buildToHide();
