...
public class AreaUpdateAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static AreaUpdateAllowProposal build(final Interaction query,
  ...
  public static AreaUpdateAllowProposal build(final Interaction query,
    ...
    return AreaUpdateAllowProposal.builder().query(query).reference(reference.orElse(null))
   ...
   * @return
   */
  public static Allow resolveWith(final Event<AreaUpdateAllowProposal> emitter,
      final AreaUpdateAllowProposal allow) {
    emitter.fire(allow);
