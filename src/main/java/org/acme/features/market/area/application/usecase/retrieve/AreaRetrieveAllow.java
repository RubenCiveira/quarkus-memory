...
public class AreaRetrieveAllow extends AllowResult {
   ...
   * @return
   */
  public static AreaRetrieveAllow build(final Interaction query, final Optional<AreaRef> reference,
  ...
  public static AreaRetrieveAllow build(final Interaction query, final Optional<AreaRef> reference,
    ...
    return AreaRetrieveAllow.builder().query(query).reference(reference.orElse(null))
