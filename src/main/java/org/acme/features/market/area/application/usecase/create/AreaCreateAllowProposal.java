...
public class AreaCreateAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static AreaCreateAllowProposal build(final Interaction query, final boolean allowed) {
  ...
  public static AreaCreateAllowProposal build(final Interaction query, final boolean allowed,
      final String reason) {
    return AreaCreateAllowProposal.builder().query(query)
   ...
   * @return
   */
  public static Allow resolveWith(final Event<AreaCreateAllowProposal> emitter,
      final AreaCreateAllowProposal allow) {
    emitter.fire(allow);
  ...
  public static Allow resolveWith(final Event<AreaCreateAllowProposal> emitter,
    ...
    return resolveWith(emitter, AreaCreateAllowProposal.build(query, allowed));
  }
