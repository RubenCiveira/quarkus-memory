...
public class RetrieveAreaUsecase {
   ...
   */
  private final Event<AreaRetrieveAllowPipelineEvent> retrieveAllow;
  ...
  public Allow allow(final Interaction query, final AreaRef reference) {
    AreaRetrieveAllowPipelineEvent base = AreaRetrieveAllowPipelineEvent.build(query,
  ...
  public Allow allow(final Interaction query) {
    AreaRetrieveAllowPipelineEvent base =
        AreaRetrieveAllowPipelineEvent.build(query, Optional.empty(), true, "Allowed by default");
    retrieveAllow.fire(base);
    return base.getDetail();
  }
