...
public class AreaCreateAllow extends AllowResult {
   ...
   * @return
   */
  public static AreaCreateAllow build(final Interaction query, final boolean allowed) {
  ...
  public static AreaCreateAllow build(final Interaction query, final boolean allowed,
      final String reason) {
    return AreaCreateAllow.builder().query(query).detail(CompletableFuture
