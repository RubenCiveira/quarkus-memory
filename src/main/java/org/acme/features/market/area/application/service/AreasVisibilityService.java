...
import org.acme.features.market.area.application.service.event.AreaFixedFieldsPipelineEvent;
import org.acme.features.market.area.application.service.event.AreaHiddenFieldsPipelineEvent;
import org.acme.features.market.area.application.service.event.AreaVisibilityQueryPipelineEvent;
import org.acme.features.market.area.application.service.event.AreaVisibleContentPipelineEvent;
...
public class AreasVisibilityService {
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<AreaFixedFieldsPipelineEvent> fireFix;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<AreaHiddenFieldsPipelineEvent> fireHide;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<AreaVisibilityQueryPipelineEvent> fireVisibleFilter;
   ...
   * @autogenerated VisibilityServiceGenerator
   */
  private final Event<AreaVisibleContentPipelineEvent> fireVisibleList;
   ...
   * @return The input entity with the copy values without hidden
   */
  public AreaDto copyWithFixed(Interaction prev, Area original, AreaDto source) {
  ...
  public Set<String> fieldsToFix(Interaction prev) {
    ...
    AreaFixedFieldsPipelineEvent value =
        AreaFixedFieldsPipelineEvent.builder().fields(fields).query(prev).build();
    fireFix.fire(value);
  ...
  public Set<String> fieldsToFix(Interaction prev, AreaRef area) {
    ...
    fields.addAll(aggregate.calcultadFields());
    AreaFixedFieldsPipelineEvent value =
        AreaFixedFieldsPipelineEvent.builder().fields(fields).area(area).query(prev).build();
    fireFix.fire(value);
    return value.getFields();
  }
  ...
  public Set<String> fieldsToHide(Interaction prev) {
    ...
    AreaHiddenFieldsPipelineEvent value =
        AreaHiddenFieldsPipelineEvent.builder().fields(fields).query(prev).build();
    fireHide.fire(value);
    return value.getFields();
  }
  ...
  public Set<String> fieldsToHide(Interaction prev, AreaRef area) {
    Set<String> fields = new HashSet<>();
    AreaHiddenFieldsPipelineEvent value =
        AreaHiddenFieldsPipelineEvent.builder().fields(fields).area(area).query(prev).build();
    fireHide.fire(value);
    return value.getFields();
  }
  ...
  private AreaFilter applyPreVisibilityFilter(Interaction prev, AreaFilter filter) {
    AreaVisibilityQueryPipelineEvent visible =
        AreaVisibilityQueryPipelineEvent.builder().filter(filter).interaction(prev).build();
  ...
  private boolean evaluatePostVisibility(Interaction prev, Area areaRef) {
    AreaVisibleContentPipelineEvent accesible = AreaVisibleContentPipelineEvent.builder()
        .visible(true).entity(areaRef).interaction(prev).build();
