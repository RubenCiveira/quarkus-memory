...
public class AreaDeleteAllow extends AllowResult {
   ...
   * @return
   */
  public static AreaDeleteAllow build(final Interaction query, final Optional<AreaRef> reference,
  ...
  public static AreaDeleteAllow build(final Interaction query, final Optional<AreaRef> reference,
    ...
    return AreaDeleteAllow.builder().query(query).reference(reference.orElse(null))
