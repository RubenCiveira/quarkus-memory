...
public class AreaDeleteAllowPipelineEvent extends AllowPipelineEvent {
   ...
   * @return
   */
  public static AreaDeleteAllowPipelineEvent build(final Interaction query,
  ...
  public static AreaDeleteAllowPipelineEvent build(final Interaction query,
    ...
    return AreaDeleteAllowPipelineEvent.builder().query(query).reference(reference.orElse(null))
