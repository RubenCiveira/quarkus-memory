...
public class AreaUpdateAllow extends AllowResult {
   ...
   * @return
   */
  public static AreaUpdateAllow build(final Interaction query, final Optional<AreaRef> reference,
  ...
  public static AreaUpdateAllow build(final Interaction query, final Optional<AreaRef> reference,
    ...
    return AreaUpdateAllow.builder().query(query).reference(reference.orElse(null))
