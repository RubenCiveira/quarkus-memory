...
public class AreaUpdateAllowPipelineEvent extends AllowPipelineEvent {
   ...
   * @return
   */
  public static AreaUpdateAllowPipelineEvent build(final Interaction query,
  ...
  public static AreaUpdateAllowPipelineEvent build(final Interaction query,
    ...
    return AreaUpdateAllowPipelineEvent.builder().query(query).reference(reference.orElse(null))
