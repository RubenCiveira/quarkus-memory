...
import org.acme.features.market.area.application.service.event.AreaFormulaBuilder;
...
public class AreasFormulaService {
   ...
   */
  private final Event<AreaFormulaBuilder> formulaBuilder;
  ...
  public CompletionStage<AreaDto> copyWithFormulas(Interaction prev, Area original,
      AreaDto source) {
    AreaFormulaBuilder formulas = AreaFormulaBuilder.builder()
  ...
  public CompletionStage<AreaDto> copyWithFormulas(Interaction prev, AreaDto source) {
    AreaFormulaBuilder formulas =
        AreaFormulaBuilder.builder().dto(CompletableFuture.completedFuture(source)).build(prev);
    formulaBuilder.fire(formulas);
    return formulas.getDto();
  }
}
