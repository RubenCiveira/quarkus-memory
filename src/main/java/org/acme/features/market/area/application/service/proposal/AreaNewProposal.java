...
public abstract class AreaNewProposal {
  ...
  public static AreaDto resolveWith(final Event<? extends AreaNewProposal> emitter,
      final AreaNewProposal proposal) {
    ((Event<AreaNewProposal>) emitter).fire(proposal);
