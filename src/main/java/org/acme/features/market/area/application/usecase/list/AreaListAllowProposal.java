...
public class AreaListAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static AreaListAllowProposal build(final Interaction query, final boolean allowed) {
  ...
  public static AreaListAllowProposal build(final Interaction query, final boolean allowed,
      final String reason) {
    return AreaListAllowProposal.builder().query(query)
   ...
   * @return
   */
  public static Allow resolveWith(final Event<AreaListAllowProposal> emitter,
      final AreaListAllowProposal allow) {
    emitter.fire(allow);
  ...
  public static Allow resolveWith(final Event<AreaListAllowProposal> emitter,
    ...
    return resolveWith(emitter, AreaListAllowProposal.build(query, allowed));
  }
