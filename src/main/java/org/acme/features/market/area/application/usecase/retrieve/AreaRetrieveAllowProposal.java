...
public class AreaRetrieveAllowProposal extends AllowProposal {
   ...
   * @return
   */
  public static AreaRetrieveAllowProposal build(final Interaction query,
  ...
  public static AreaRetrieveAllowProposal build(final Interaction query,
    ...
    return AreaRetrieveAllowProposal.builder().query(query).reference(reference.orElse(null))
   ...
   * @return
   */
  public static Allow resolveWith(final Event<AreaRetrieveAllowProposal> emitter,
      final AreaRetrieveAllowProposal allow) {
    emitter.fire(allow);
