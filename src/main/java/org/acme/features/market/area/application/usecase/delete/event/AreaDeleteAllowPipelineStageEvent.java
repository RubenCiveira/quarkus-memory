package org.acme.features.market.area.application.usecase.delete.event;
...
public class AreaDeleteAllowPipelineStageEvent extends AllowPipelineStageEvent {
   ...
   * @return
   */
  public static AreaDeleteAllowPipelineStageEvent build(final Interaction query,
  ...
  public static AreaDeleteAllowPipelineStageEvent build(final Interaction query,
    ...
    return AreaDeleteAllowPipelineStageEvent.builder().query(query)
