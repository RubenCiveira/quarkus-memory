...
public class AreaNameVO {
   ...
   */
  public static AreaNameVO from(final String name) {
    return tryFrom(name);
  }
   ...
   * @return An empty instance
   */
  public static AreaNameVO tryFrom(final Object name) {
    ConstraintFailList list = new ConstraintFailList();
    AreaNameVO result = tryFrom(name, list);
    if (list.hasErrors()) {
   ...
   * @return An empty instance
   */
  public static <T extends AbstractFailList> AreaNameVO tryFrom(final Object name, final T fails) {
    if (null == name) {
      fails.add(new ConstraintFail("not-null", "name", null, "Cant be null"));
      return null;
    } else if (name instanceof String) {
      return new AreaNameVO((String) name);
    } else {
